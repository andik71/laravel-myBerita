                    ...
                    <div class="swiper sliderFeaturedPosts">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="{{ url('/') }}" class="img-bg d-flex align-items-end"
                                    style="background-image: url({{ url('img/post-slide-1.jpg') }});">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ url('/') }}" class="img-bg d-flex align-items-end"
                                    style="background-image: url({{ url('img/post-slide-2.jpg') }});">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ url('/') }}" class="img-bg d-flex align-items-end"
                                    style="background-image: url({{ url('img/post-slide-3.jpg') }});">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ url('/') }}" class="img-bg d-flex align-items-end"
                                    style="background-image: url({{ url('img/post-slide-4.jpg') }});">
                                    <div class="img-bg-inner">
                ...
                <div class="col-lg-8">
                    ...
                    @foreach ($article as $row)
                        <div class="post-entry-1 lg">
                            <a href="{{ url('/detail') }}"><img src="{{ url('storage') }}/{{ $row->photo }}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">{{ $row->category->category }}</span> <span
                                    class="mx-1">&bullet;</span>
                                <span>{{ $row->created_at }}</span>
                            </div>
                            <h2><a href="single-post.html">{{ $row->title }}</a></h2>
                            <p class="mb-4 d-block">{!! html_entity_decode($row->content) !!}</p>

                            <div class="d-flex align-items-center author">
                                <div class="photo"><i class="bi bi-person-circle"></i></div>
                                <div class="name">
                                    <h3 class="m-0 p-0">{{ $row->author->name }}</h3>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-1.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-2.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
            ...
            <div class="row">
                <div class="col-md-9 order-md-2">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        ...
                        <div>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem
                                ...
                                temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ url('img/person-4.jpg') }}" alt="" class="img-fluid">
                                </div>
                                <div class="name">
                                    <h3 class="m-0 p-0">Wade Warren</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-5.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="single-post.html">11 Work From Home Part-Time Jobs You Can Do
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-7.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="single-post.html">How to Avoid Distraction and Stay Focused
    ...
    <section class="category-section">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="{{ url('img/post-landscape-8.jpg') }}" alt=""
                                class="img-fluid"></a>
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{ url('img/person-7.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="name">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-6.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-4.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Mar 15th '22</span></div>
                                <h2><a href="single-post.html">Why Craigslist Tampa Is One of The Most Interesting Places
                                        On the Web?</a></h2>
                            </div>
                        </div>
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ url('img/post-landscape-3.jpg') }}" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
